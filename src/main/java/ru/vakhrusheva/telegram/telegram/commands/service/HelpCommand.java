  ...
  public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
    ...
    sendAnswer(
        ...
        "Я бот, который поможет вам проверить свои знания английских слов\n\n"
            ...
            + "/help - помощь\n\n"
            + "Если вы выберете отправку файла со словами, то я напомню вам о повторении слов 4 раза после "
            + "первого ознакомления с файлом, просто отправив вам эти слова снова.\n\n"
